...
if (isLoading && enrollments.length === 0) {
  ...
  const renderEnrollmentCard = (enrollment: Enrollment) => {
    const courseTitle = courses[enrollment.courseId]?.title || "Loading...";
    const courseCategory = courses[enrollment.courseId]?.category || "Loading...";
        ...
        >
            ...
            <View style={styles.cardDetails}>
                ...
                <View style={styles.detailRow}>
                  ...
                  <Text style={[styles.detailValue, getStatusStyle(enrollment.status)]}>{getStatusText(enrollment.status)}</Text>
                </View>
                {enrollment.completionDate && (
                    <View style={styles.detailRow}>
                        <Text style={styles.detailLabel}>Date d'achèvement :</Text>
            ...
            >
                <Text style={styles.actionButtonText}>Voir le cours</Text>
            </TouchableOpacity>
            }
        </View>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.pageTitle}>Mes inscriptions</Text>
      ...
      >
        ...
        {!isLoading && !error && enrollments.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateTitle}>Aucune inscription trouvée</Text>
            <Text style={styles.emptyStateDescription}>
              Vous n'êtes actuellement inscrit(e) à aucun cours. Explorez notre catalogue pour trouver votre prochaine opportunité d'apprentissage !
            </Text>
            <TouchableOpacity
...
// Helper function to translate status text to French
