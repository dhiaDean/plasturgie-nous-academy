...
const FALLBACK_API_URL = 'http://192.168.1.11:5000/api';
...
export const API_ENDPOINTS = {
  ...
  PRACTICAL_SESSIONS: {
    ME: `${API_BASE_URL}/practical-sessions/user/me/upcoming`, // For current user's sessions
    // ALL: `${API_BASE_URL}/practical-sessions`, // Example for all sessions
  }
};
