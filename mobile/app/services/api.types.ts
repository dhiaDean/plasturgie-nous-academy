...
export interface PracticalSession {
  id: number; // Or string if your backend uses string IDs
  title: string;
  trainingTitle: string; // Assumes backend sends this. If not, use courseId.
  courseId?: number; // Include if backend sends this and trainingTitle is not direct
  sessionDate: string;   // ISO Date String
  location: string;
  tutorName: string;
  tutorAvatar?: string; // Optional URL
  // We will determine 'isFuture' on the frontend
}
