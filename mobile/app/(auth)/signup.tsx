...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    try {
        console.log('Tentative d\'inscription pour :', registerData.username);
        ...
        const message = error?.response?.data?.message || error?.message || 'Échec de l\'inscription. Veuillez réessayer.';
