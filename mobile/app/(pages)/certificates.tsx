...
import { generateCertificatePDF } from '../utils/pdf.helper'; // Adjust the path
import {
    View,
    Text,
    StyleSheet,
        ...
        {!error && certificates.length > 0 && (
          <View style={[styles.certificatesGrid, { gap: 16 }]}>
            {certificates.map((certificate) => {
              const courseTitle = courses[certificate.courseId]?.title || "Détails du cours non disponibles";//Détails du cours non disponibles 
              return (
                <View key={certificate.id ?? certificate.certificationId} style={[
                  ...
                  <View style={styles.cardDetails}>
                    ...
                    <View style={styles.detailRow}>
                      ...
                      <Text style={[styles.detailValue, getStatusStyle(certificate.status)]}>{getStatusText(certificate.status)}</Text>
                    </View>
