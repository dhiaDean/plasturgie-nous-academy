...
// --- Mock Data (Updated with French text and Tunisia address) ---
const enterprise = {
  id: 1,
  companyName: 'PlastTech Industries',
  address: '123 Avenue de l\'Innovation, Parc Technologique, Tunis 1082, Tunisie',
  contactNumber: '+216 70 123 456',
};

const subscriptions = [
  {
    id: 1,
    planName: 'Entreprise Basique',
...
const EnterprisesScreenLight = () => {
  ...
  const handleAddSubscription = () => {
    if (!planName || !employeeCount || isNaN(Number(employeeCount)) || Number(employeeCount) < 1) {
        alert('Veuillez saisir un nom de plan valide et un nombre d\'employés (au moins 1).');
        return;
    }
  ...
  <View style={{ flex: 1 }}>
    <Text style={styles.headerTitle}>Gestion des</Text>
    <Text style={styles.headerTitle}>Entreprises</Text>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.cardTitle}>Détails de l'Entreprise</Text>
          </View>
