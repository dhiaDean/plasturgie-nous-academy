...
// Add this at the top of your ProfileScreen component
useEffect(() => {
    console.log('ProfileScreen: User object changed:', JSON.stringify(user));
    console.log('ProfileScreen: Username value:', user?.username);
    console.log('ProfileScreen: Email value:', user?.email);
  }, [user]);
                ...
                <View style={styles.contentPadding}>
                    ...
                    <View style={styles.section}>
                        ...
                        {isLoadingCerts ? (
                            ...
                            <Text style={styles.errorText}>Impossible de charger les certificats.</Text>
